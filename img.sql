...
UPDATE products SET image = 'bottretluong.jpg' WHERE id = 18;
...
UPDATE products SET image = 'thepcayphi.jpg' WHERE id = 27;
...
UPDATE products SET image = 'ongnuoigoc90.jpg' WHERE id = 32;
UPDATE products SET image = 'vankhoanuoc.jpg' WHERE id = 33;
UPDATE products SET image = 'maybomnuoc.jpg' WHERE id = 34;
UPDATE products SET image = 'daydiencadivi.jpg' WHERE id = 35;
UPDATE products SET image = 'ongluongaydien.jpg' WHERE id = 36;
...
UPDATE products SET image = 'sangcongnghiep.jpg' WHERE id = 44;
...
UPDATE products SET image = 'tubephomkinh.jpg' WHERE id = 48;
UPDATE products SET image = 'tonlanhxxanh.jpg' WHERE id = 49;
UPDATE products SET image = 'xopdantuong.jpg' WHERE id = 50;
UPDATE products SET image = 'tamlopasang.jpg' WHERE id = 51;
UPDATE products SET image = 'chongtham.jpg' WHERE id = 52;
UPDATE products SET image = 'palletgo.jpg' WHERE id = 53;
UPDATE products SET image = 'bacchumau.jpg' WHERE id = 54;
